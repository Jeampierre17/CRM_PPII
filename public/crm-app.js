...
const camps=[
  ...
  {n:'Retención Q2 2026',t:'Email + SMS',s:'activo',se:890,o:41,cl:12,pr:60,pc:'#0176D3'},
...
function om(){
  const M={
    ...
    marketing:{t:'Nueva campaña',h:'<div class="fg"><label class="fl">Nombre</label><input class="fi" placeholder="Campaña Q3 2026"></div><div class="fr2"><div class="fg"><label class="fl">Tipo</label><select class="fs"><option>Email</option><option>SMS</option><option>Email + SMS</option></select></div><div class="fg"><label class="fl">Segmento</label><select class="fs"><option>Premium</option><option>Estándar</option><option>Todos</option></select></div></div><div class="fg"><label class="fl">Fecha de envío</label><input class="fi" type="date"></div>'},
